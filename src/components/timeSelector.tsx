...
const TimeSelector: React.FC<TimeSelectorProps> = ({ selectedTime, selectedDate, onTimeClick }) => {
  ...
  return (
    <div className="flex flex-col gap-4 p-4 w-[400px] h-[400px] rounded-2xl border-2 px-4">
      ...
      <div className="overflow-scroll border-2 p-4 hide-scrollbar flex flex-col gap-5">
        <div>
